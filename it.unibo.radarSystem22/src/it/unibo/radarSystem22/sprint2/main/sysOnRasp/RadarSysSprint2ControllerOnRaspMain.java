...
public class RadarSysSprint2ControllerOnRaspMain implements IApplication{
	...
	public void setup( String domainConfig, String systemConfig ) throws JSONException  {
		...
		if( domainConfig == null && systemConfig == null) {
	    	...
	    	DomainSystemConfig.ledGui      = false;	// !!!!!!  da mettere a false sul Rasp !!!!!!!	
	    	
			RadarSystemConfig.RadarGuiRemote    = true;	//perchè non devo creare un radar in locale
			RadarSystemConfig.serverPort        = 8080;		
			RadarSystemConfig.hostAddr          = "192.168.178.88";
